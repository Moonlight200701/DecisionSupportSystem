...
//                System.out.println(diemPhuHopNguyenLieu);
...
//                }
    ...
    public float tinhdophuhopdinhduong(float luongcaloyeucau, float luongcalocuamon) {
        ...
        if (chenhlechdinhduong == 0) {
            ...
            if(chenhlechdinhduong <0.5) {
                dophuhopdinhduong = -(chenhlechdinhduong) + 6;
            }
        } else dophuhopdinhduong = chenhlechdinhduong + 2;
                if(dophuhopdinhduong < 0){
                    dophuhopdinhduong = 0.002f;
                };
    ...
    public ObservableList<DiemMonAn> topSis(ObservableList<DiemMonAn> listDiemMonAn){
        ...
        //
        for (DiemMonAn diemMonAn : listDiemMonAn) {
            double diemDinhDuong = Math.round((diemMonAn.getGiaTriDinhDuong()/sumDinhDuong)*0.4* 10000) / 10000.0;
            double diemNguyenLieu = Math.round((diemMonAn.getNguyenLieu1()/sumNguyenLieu)*0.1* 10000) / 10000.0;
